      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[60] bg-[#08090B]/98 backdrop-blur-lg flex flex-col">
          <div className="flex items-center justify-between px-6 py-5">
            <Image src="/logo.jpeg" alt="Bet Vault" width={40} height={40} className="rounded-full object-contain" />
            <button
          ...
          <div className="flex flex-col items-center justify-center flex-1 gap-2">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() => setMenuOpen(false)}
              className="mt-8 inline-flex items-center gap-2 btn-emerald px-7 py-3.5 rounded-full text-sm font-bold"
            >
              <WhatsAppIcon className="w-4 h-4" />
